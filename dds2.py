...
def main():
    ...
    parser.add_argument("--rate", type=int, default=1000, help="Target packets per second (e.g., 1000). WARNING: High rates + packet printing will flood console!") # Reduced default rate
